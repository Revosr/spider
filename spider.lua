...
os.execute('wget https://raw.githubusercontent.com/spider/Revosr/master/spider.lua')
os.execute('wget https://raw.githubusercontent.com/spider/Revosr/master/start.lua')
dofile('spider.lua')  
return false
end
if text == "راسلني" then
